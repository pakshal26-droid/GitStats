  ...
  const downloadCard = async () => {
    ...
    try {
      const dataUrl = await htmlToImage.toPng(cardRef.current, {
        quality: 1.0,
        pixelRatio: 2,
        backgroundColor: "#111827", // Ensure a solid background color
        style: {
          boxShadow: "none", // Remove shadows during capture
    ...
    <div className="flex flex-col items-center gap-4 w-full px-4 sm:px-0">
      ...
      >
        <div className="relative bg-gradient-to-br from-gray-900 via-gray-950 to-black p-4 sm:p-8 rounded-2xl overflow-hidden shadow-[0_0_40px_rgba(79,70,229,0.15)] border border-indigo-900/30">
          ...
          <div className="relative">
            <div className="absolute -top-7 sm:-top-9 left-1/2 transform -translate-x-1/2 px-3 py-1 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-full text-xs sm:text-sm text-white font-medium shadow-lg shadow-indigo-900/30">
              GITHUB ACHIEVEMENTS
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 sm:gap-6 relative z-10">
              ...
              >
                ...
                <div className="flex items-center mb-2 sm:mb-4">
                  ...
                  <span className="text-sm sm:text-xl font-medium text-purple-300">Pull Requests</span>
                </div>

                <div className="text-white text-3xl sm:text-5xl font-bold mb-2 sm:mb-3 flex items-end">
                  {prStats.totalPRs}
              ...
              >
                ...
                <div className="flex items-center mb-2 sm:mb-4">
                  ...
                  <span className="text-sm sm:text-xl font-medium text-blue-300">Commits</span>
                </div>

                <div className="text-white text-3xl sm:text-5xl font-bold mb-2 sm:mb-3 flex items-end">
                  {commitStats.total}+
                  <span className="text-blue-400 text-sm sm:text-lg ml-1 sm:ml-2 mb-0.5 sm:mb-1">commits</span>
                </div>
              ...
              >
                ...
                <div className="flex items-center mb-2 sm:mb-4">
                  ...
                  <span className="text-sm sm:text-xl font-medium text-cyan-300">Open Source</span>
                </div>
